...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20260731172318_AddGuestHostRoles_BanCount_PendingDeletion_AccountDeletionTokens")]
    partial class AddGuestHostRoles_BanCount_PendingDeletion_AccountDeletionTokens
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Apartments.Apartment", b =>
                {
                    ...
                    b.Property<int>("BaseGuests")
                        ...
                        .HasColumnType("integer")
                        .HasDefaultValue(1)
                        .HasColumnName("base_guests");

                    b.Property<Guid?>("CancellationPolicyId")
                        .HasColumnType("uuid")
                        .HasColumnName("cancellation_policy_id");

                    b.Property<int>("CheckInCutOffHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(3)
                        .HasColumnName("check_in_cut_off_hours");
                    ...
                    b.HasIndex("CancellationPolicyId")
                        .HasDatabaseName("ix_apartments_cancellation_policy_id");
            ...
            modelBuilder.Entity("Bookify.Domain.Apartments.Apartment", b =>
                {
                    b.HasOne("Bookify.Domain.CancellationPolicies.CancellationPolicy", null)
                        .WithMany()
                        .HasForeignKey("CancellationPolicyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_apartments_cancellation_policy_cancellation_policy_id");
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.Money", "ExtraGuestFee", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<decimal>("Amount")
                                ...
                                .HasColumnType("numeric")
                                .HasDefaultValue(0m)
                                .HasColumnName("extra_guest_fee_amount");

                            b1.Property<string>("Currency")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("extra_guest_fee_currency");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.Money", "ExtraGuestCharge", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<decimal>("Amount")
                                ...
                                .HasColumnType("numeric")
                                .HasDefaultValue(0m)
                                .HasColumnName("extra_guest_charge_amount");

                            b1.Property<string>("Currency")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("extra_guest_charge_currency");
