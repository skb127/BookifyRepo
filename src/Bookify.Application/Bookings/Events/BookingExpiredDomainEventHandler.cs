...
internal sealed class BookingExpiredDomainEventHandler : INotificationHandler<BookingExpiredDomainEvent>
{
    ...
    public BookingExpiredDomainEventHandler(
    ...
    public async Task Handle(BookingExpiredDomainEvent notification, CancellationToken cancellationToken)
    {
