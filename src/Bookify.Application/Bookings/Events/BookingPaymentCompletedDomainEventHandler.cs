...
internal sealed class BookingPaymentCompletedDomainEventHandler : INotificationHandler<BookingPaymentCompletedDomainEvent>
{
    ...
    public BookingPaymentCompletedDomainEventHandler(
