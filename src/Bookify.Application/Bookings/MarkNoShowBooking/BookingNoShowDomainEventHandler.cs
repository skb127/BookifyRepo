...
internal sealed class BookingNoShowDomainEventHandler : INotificationHandler<BookingNoShowDomainEvent>
{
    ...
    public BookingNoShowDomainEventHandler(
    ...
    public async Task Handle(BookingNoShowDomainEvent notification, CancellationToken cancellationToken)
    {
