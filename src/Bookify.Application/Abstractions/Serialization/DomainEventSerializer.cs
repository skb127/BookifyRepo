...
public static class DomainEventSerializer
{
    private static readonly Dictionary<string, Type> EventTypes = new(StringComparer.Ordinal)
    {
        ...
        { nameof(UserAccountDeletionRequestedDomainEvent), typeof(UserAccountDeletionRequestedDomainEvent) },
        { nameof(UserAccountDeletionCancelledDomainEvent), typeof(UserAccountDeletionCancelledDomainEvent) },
        { nameof(UserBannedDomainEvent), typeof(UserBannedDomainEvent) },
        { nameof(UserUnbannedDomainEvent), typeof(UserUnbannedDomainEvent) },
        ...
        { nameof(BookingRefundCompletedDomainEvent), typeof(BookingRefundCompletedDomainEvent) },
