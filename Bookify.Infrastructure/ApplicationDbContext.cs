...
public sealed class ApplicationDbContext : DbContext, IUnitOfWork
{
    ...
    /// e.g: There could be another database context created which could use the same entry and add another domain event and that is going to cause strange behavior.
