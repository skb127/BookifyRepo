...
public class BookingPaymentCompletedDomainEventHandlerTests
{
    private readonly IBookingRepository _bookingRepositoryMock;
    private readonly IUserRepository _userRepositoryMock;
    private readonly IEmailService _emailServiceMock;
    private readonly IEmailTemplateService _emailTemplateServiceMock;
    private readonly BookingPaymentCompletedDomainEventHandler _handler;

    public BookingPaymentCompletedDomainEventHandlerTests()
    {
        ...
        _handler = new BookingPaymentCompletedDomainEventHandler(
    ...
    {
        // Arrange
        var domainEvent = new BookingPaymentCompletedDomainEvent(Guid.NewGuid(), "intent-id");
    ...
    {
        // Arrange
        var domainEvent = new BookingPaymentCompletedDomainEvent(Guid.CreateVersion7(), "intent-id");
        ...
        await _emailServiceMock.Received(1).SendAsync(
            Arg.Is<EmailMessage>(m =>
                ...
                m.Subject == "Booking Payment Completed" &&
