...
public class GetBookingsQueryValidatorTests
{
    ...
    {
        // Arrange
        var query = new GetBookingsQuery(null, null, null, null, null, Page: 0, PageSize: 20);
    ...
    {
        // Arrange
        var query = new GetBookingsQuery(null, null, null, null, null, Page: 1, PageSize: 101);
    ...
    {
        // Arrange
        var query = new GetBookingsQuery(null, null, Status: status, null, null, Page: 1, PageSize: 20);
    ...
    {
        // Arrange
        var query = new GetBookingsQuery(null, null, Status: null, null, null, Page: 1, PageSize: 20);
